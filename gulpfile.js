...
const paths = {
	root: './wp-content/themes/idealist',
	templates: {
		pages: ['./src/pug/pages/*.pug', './src/pug/pages/includes/*.pug'],
		src: './src/pug/**/*.pug',
		dest: './wp-content/themes/idealist',
	},
	styles: {
	...
	scripts: {
		...
		dest: './wp-content/themes/idealist/assets/s3d/scripts/',
	},
	fonts: {
		src: './src/assets/fonts/**/*',
		dest: './wp-content/themes/idealist/assets/fonts',
	},
	images: {
		src: './src/assets/s3d/images/**/*',
		dest: './wp-content/themes/idealist/assets/s3d/images',
	},
	svgSprite: {
	...
	static: {
		src: './src/static/**/*.*',
		dest: './wp-content/themes/idealist/static/',
	},

	json: {
		src: './src/assets/s3d/*.json',
		dest: './wp-content/themes/idealist/assets/s3d/',
	},
}
...
// lint
function esLint() {
	return gulp.src(['src/assets/s3d/scripts/**/*.js', 'src/assets/s3d/scripts/gulp-modules/*.js', '!node_modules/**', '!src/assets/s3d/scripts/**/libs.js', '!src/assets/s3d/scripts/**/gsap.js', '!src/assets/s3d/scripts/libs/jquery/**/*.js', '!src/assets/s3d/scripts/libs/ion.rangeSlider/**/*.js', '!src/assets/s3d/scripts/libs/magnific-popup/**/*.js'])
